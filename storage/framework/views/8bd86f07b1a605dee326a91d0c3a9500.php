...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => __('Perfil'),'subheading' => __('Actualiza tu nombre y correo electrónico')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Perfil')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Actualiza tu nombre y correo electrónico'))]); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3246310782-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
</section><?php /**PATH /Users/edgardeganteaguilar/Herd/cafinedv3/resources/views/livewire/settings/profile.blade.php ENDPATH**/ ?>