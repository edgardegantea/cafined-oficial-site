        ...
        <div class="max-w-screen-xl mx-auto px-4 lg:px-8">
            ...
            <div class="mb-32">
                ...
                <div class="flex flex-col gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $publications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $publication): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <article class="group p-6 md:p-8 bg-white dark:bg-gray-800/40 rounded-2xl shadow-sm hover:shadow-md dark:hover:shadow-lg dark:hover:shadow-black/300 transition-all duration-300 hover:-translate-y-1 flex flex-col md:flex-row gap-6 md:gap-12">
                            ...
                            <span class="text-xl md:text-2xl font-bold text-blue-600 dark:text-blue-400">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($publication->journal): ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($publication->publisher): ?>
                            ...
                            <div class="md:w-3/4 flex flex-col justify-center">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($publication->authors): ?>
                                ...
                                <div class="flex items-center gap-6 text-sm font-semibold uppercase tracking-wider mt-auto">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($publication->url): ?>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($publication->doi): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(method_exists($publications, 'links')): ?>
                    <div class="mt-12">
...
<?php endif; ?><?php /**PATH /Users/edegantea/development/test/var/www/vhosts/cafined.org/v2.cafined.org/resources/views/frontend/info/produccioncientifica.blade.php ENDPATH**/ ?>