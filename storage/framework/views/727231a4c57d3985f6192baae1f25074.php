...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'solid','color' => 'zinc','size' => 'xs','class' => 'text-xs font-mono font-light mt-2']); ?>Publicado el: <?php echo e($post->published_at->locale('es_ES')->isoFormat('LL')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/cafined.org/v2.cafined.org/resources/views/frontend/posts/index.blade.php ENDPATH**/ ?>