...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
    ¡Hola, <?php echo e(explode(' ', $user->name)[0]); ?>!
        Nos alegra informarte que te has inscrito exitosamente. Tu lugar está reservado al evento **<?php echo e($event->title); ?>** Aquí tienes los detalles completos para que te organices:

        Fecha de inicio: <?php echo e($event->start_time->locale('es')->isoFormat('dddd D [de] MMMM, YYYY')); ?>

        Horario: <?php echo e($event->start_time->format('h:i A')); ?> - <?php echo e($event->end_time->format('h:i A')); ?>

        Tipo de evento: <?php echo e(ucfirst($event->type)); ?>
...
<?php endif; ?><?php /**PATH /var/www/vhosts/cafined.org/v2.cafined.org/resources/views/emails/events/registration.blade.php ENDPATH**/ ?>