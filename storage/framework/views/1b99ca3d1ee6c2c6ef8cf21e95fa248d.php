    ...
    $groups = [
        'Platform' => [
            ...
            [
                ...
                'current'    => request()->routeIs('admin.publications.*'),
            ],
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::sidebar.index','data' => ['sticky' => true,'stashable' => true,'class' => 'border-e bg-white dark:border-b-zinc-950 dark:bg-zinc-900']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['sticky' => true,'stashable' => true,'class' => 'border-e bg-white dark:border-b-zinc-950 dark:bg-zinc-900']); ?>
...
<?php endif; ?>
    ...
    <a href="<?php echo e(route('dashboard')); ?>" class="me-5 flex items-center space-x-2 rtl:space-x-reverse font-extrabold" wire:navigate>
        CAFINED LAB
    </a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::navlist.group','data' => ['heading' => $group,'class' => 'grid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($group),'class' => 'grid']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($link['icon']),'href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($link['url']),'current' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($link['current']),'wire:navigate' => true]); ?><?php echo e($link['name']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /var/www/vhosts/cafined.org/v2.cafined.org/resources/views/components/layouts/app/sidebar.blade.php ENDPATH**/ ?>