        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="grid gap-12 lg:grid-cols-2 items-center">
                ...
                <div class="flex flex-col justify-center">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('saberes360/privacidad') }}" class="inline-flex items-center text-sm font-medium text-gray-500 hover:text-blue-700 dark:text-gray-500 dark:hover:text-blue-400 hover:text-blue-900 transition-colors">
                ...
                <div class="relative group">
                    ...
                    <img src="{{ asset('storage/equipo/itzelespinozalopez.jpeg') }}"
