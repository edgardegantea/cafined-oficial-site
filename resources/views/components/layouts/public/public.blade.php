  ...
  <a href="https://github.com/cafined" class="flex items-center hover:underline">
    ...
    cafined@itsm.edu.mx
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© <?php echo date('Y'); ?>. <a href="https://cafined.org/" class="hover:underline">cafined lab™</a>. All Rights Reserved. Created by <a href="https://cafined.org/angelarmenta/" class="hover:underline">Roberto Ángel Meléndez-Armenta</a>. Developed by <a href="https://cafined.org/edegantea/" class="hover:underline">edegantea <3</a>.
          </span>
